...
Almost two years ago [I've written](http://dimaip.github.io/2015/04/18/caching-typoscript/) about some tips on how caching in Neos CMS works. At that time I thought I fully understood how caching in Fusion had worked, but how wrong had I been! In this article, I want to share with you the things I recently learned about the Fusion caching system, that you might not have known too.
</div>
